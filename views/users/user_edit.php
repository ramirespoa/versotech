            ...
            <div class="card-body">
                <form method="post" action="/users/update">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $user['name']; ?>" name="name" id="name" placeholder="Name">
                        <label for="title">E-mail</label>
                        <input type="text" class="form-control" value="<?php echo $user['email']; ?>" name="email" id="email" placeholder="E-mail">
